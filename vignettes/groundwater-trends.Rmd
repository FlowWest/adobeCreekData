...
#     min = min(difference), 
#     end_year_type = first(end_year_type)
#   ) %>% 
#   ggplot(aes(end_year, mean)) + geom_point(aes(color=end_year_type), size=4) + geom_line()
```
...
elevation change as a result of the water year types. (right?)
